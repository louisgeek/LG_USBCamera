...
public class TextureMovieEncoder implements Runnable {
    ...
    public static NetworkNative mNetworkNative = new NetworkNative();
...
//        mVideoEncoder.drainEncoder(true);
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate, File output) {
        try {
            mVideoEncoder = new VideoEncoderCore2(width, height, bitRate);
